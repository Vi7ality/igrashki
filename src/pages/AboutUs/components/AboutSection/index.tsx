  ...
  return (
    <SectionStyled>
      <ContentContainer>
        ...
        <TextStyled>
          <span>Участь у програмі повністю безкоштовна.</span><br/>Наразі проєкт реалізується у Чернівецькій,
          Тернопільській, Івано-Франківській та Закарпатській та Львівській областях.
        </TextStyled>
      </ContentContainer>
    </SectionStyled>
  );
