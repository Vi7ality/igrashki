...
import topCenterFig from './assets/topCenterFig.png';
...
const Subscription = () => {
    ...
    return (
        <div className={styles.subscriptionContainer}>
            ...
            <img src={topCenterFig} className={styles.topCenterFig} alt="" />
            ...
            <div className={styles.leftContent}>
                <Link to="/" >
                    <div className={styles.logoContainer}>
                        <img src={logoDark} alt="GROW WITH U" className={styles.logo} />
                    </div>
                </Link>
                <div className={styles.headerSub}>
                    <h1 className={styles.hed}>Підписка на план</h1>
                    {!client?._id && (<>
                        <p>Якщо ви вже заповнили анкету у одній з бібліотек або онлайн — увійдіть до свого облікового запису, натиснувши кнопку нижче</p>
                        <button onClick={() => setIsAuthModalOpen(true)} className={styles.accountBtn}>Увійти</button>
                    </>)}

                </div>
                <form onSubmit={handleSubmit} className={styles.subscriptionForm} id='formId'>
                    <div className={styles.field}>
                        <label htmlFor="managementPoint" className={styles.fieldLabel}>Локація</label>
                        <input className={styles.fieldInput} value={selectedManagementPoint ? selectedManagementPoint.location : ""} disabled />
                    </div>
                    {!client?._id ? (<>
                        <div className={styles.field}>
                            <label htmlFor="parentSurname" className={styles.fieldLabel}>Прізвище</label>
                            <input
                                type="text"
                                name="parentSurname"
                        ...
                        <div className={styles.field}>
                            <label htmlFor="parentName" className={styles.fieldLabel}>Ім'я</label>
                            <input
                                type="text"
                                name="parentName"
                                className={styles.fieldInput}
                        ...
                        <div className={styles.field}>
                            <label htmlFor="phoneNumber" className={styles.fieldLabel}>Мобільний номер</label>
                            <InputMask
                        ...
                        <div className={styles.field}>
                            <label htmlFor="phoneNumber" className={styles.fieldLabel}>Ім'я дитини</label>
                            <input
                                type="text"
                                name="childName"
                                className={styles.fieldInput}
                        ...
                        <div className={styles.field}>
                            <label htmlFor="childBirthDate" className={styles.fieldLabel} >Дата народження дитини</label>
                            <input
                                type="date"
                                name="childBirthDate"
                                className={styles.fieldInput}
                        ...
                        <div className={styles.fieldCheckbox}>
                            <label
                                ...
                                onClick={() => setClientValues({ ...clientValues, acceptRules: !clientValues.acceptRules })}>
                                <img
                                    src={clientValues.acceptRules ? checkedImg : checkbox}
                                    className={styles.checkedImg}
                                />
                                <span className={styles.checkboxText}>Я надаю згоду на оброблення персональних даних</span>
                            </label>
                        </div>
                        <label className={styles.messengerLabel} htmlFor="messenger">Оберіть месенджер, у якому вам зручніше продовжити спілкування:</label>
                        <div className={styles.messengerCheck}>
                            <label className={styles.checkboxLabel} onClick={() => setClientValues({ ...clientValues, messenger: "viber" })}>
                                <img src={clientValues.messenger === "viber" ? checkedVb : checkboxVb} alt="checkboxVb" />
                                <span className={styles.checkboxVb}>Viber</span>
                            </label>

                            <label className={styles.checkboxLabel} onClick={() => setClientValues({ ...clientValues, messenger: "telegram" })}>
                                <img src={clientValues.messenger === "telegram" ? checkedTg : checkboxTg} alt="checkboxTg" />
                    ...
                    <button disabled={!clientValues.acceptRules && !client?._id} type="submit" className={styles.btnSubmit}>Відправити</button>
                </form>
            </div>
            <div className={styles.rightContent}>
                ...
                <div className={styles.container}>
                    ...
                    <div className={styles.contentBox}>
                        ...
                        <button className={styles.btnEdit} onClick={() => setIsEditing(!isEditing)}>Редагувати</button>
                    </div>
                </div>
                <div className={styles.orderContainer}>
                    {cart.map((item) => (
                        <OrderedToy key={item.itemId} itemImage={item.itemImage} itemId={item.itemId} itemName={item.itemName} onDelete={handleDeleteItem} isEditing={isEditing} />
                    ))}
                </div>
                <hr className={styles.line} />
                <button disabled={!clientValues.acceptRules && !client?._id} type="submit" form='formId' className={styles.SecondBtnSubmit}>Відправити</button>
            </div>
